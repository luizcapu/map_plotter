...
class GradientGenerator(object):
    ...
    # original code from http://bsou.io/posts/color-gradients-with-python
    ...
    def color_dict(gradient):
        ''' Takes in a list of RGB sub-lists and returns dictionary of
          ...
          defined later on '''
        return {"hex": [GradientGenerator.RGB_to_hex(RGB) for RGB in gradient],
...
if __name__ == '__main__':
    ...
    print GradientGenerator.linear_gradient("#007F00", "#FF4C4C")  # green to red
